...
public class DataCaluseUtils {
    public static void main(String[] args) {
        getDates("2018-02-01", "2018-02-02","星期四");
    }
    ...
    public static List<String> getDates(String dateFrom, String dateEnd, String weekDays) {
        ...
        //需要查询的星期系数
        String teststrWeekNumber = weekForNum(weekDays);
        ...
        try {
            ...
            while (true) {
                ...
                if (dateFrom != null && dateEnd !=null && dateFrom.compareTo(dateEnd) <= 0) {
                    //查询的某一时间的星期系数
                    Integer weekDay = dayForWeek(date);
                    //判断当期日期的星期系数是否是需要查询的
                    if (teststrWeekNumber.indexOf(weekDay.toString())!=-1) {
